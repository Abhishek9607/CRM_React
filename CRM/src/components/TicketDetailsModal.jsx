function TicketDetailsModal({ticket}) {
  return (
    ...
    <div className="modal-box">
        ...
        <textarea className="bg-white text-black my-2 rounded-lg resize-none p-2 w-full" name="description"
        cols="50"
        rows="7"
        ...
        <div className="modal-action">
            <button className='btn-success px-4 py-2 rounded-md hover:bg-green-400 transition-all ease-in-out duration-200'>Upadate ticket</button>
        </div>
    </div>
